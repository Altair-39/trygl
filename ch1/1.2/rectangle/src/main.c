...
int main() {
  ...
  // vertices of the rectangle, the z is 0 to make it 2D
  float vertices[] = {
  ...
  // Element Buffer Object (EBO): necessary for sending data to the GPU
  unsigned int EBO;
  glGenBuffers(1, &EBO);

  // To bind our buffer to GL_ELEMENT_ARRAY_BUFFER
  glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, EBO);

  // To copy our indices in memory
